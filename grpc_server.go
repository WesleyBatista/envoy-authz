...
var (
    grpcport = flag.String("grpcport", ":22222", "grpcport")
    conn     *grpc.ClientConn
    hs       *health.Server
)

const (
    address string = ":22222"
)
...
// AuthorizationServer we need to have comments here
type AuthorizationServer struct{}

// Check we need to have comments here
...
func main() {
    ...
    if *grpcport == "" {
        fmt.Fprintln(os.Stderr, "missing -grpcport flag (:22222)")
        flag.Usage()
        os.Exit(2)
    }
